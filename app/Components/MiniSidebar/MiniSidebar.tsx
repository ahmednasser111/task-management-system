			...
			<div className='mt-8 flex-1 flex flex-col items-center justify-between'>
				...
				<div className='mb-[1.5rem]'>
					<div className='relative group'>
						...
						{/* Hover Tooltip */}
						<span className='u-triangle absolute left-14 top-1/2 -translate-y-1/2 text-xs pointer-events-none text-white bg-[#3aafae] px-2 py-1 rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap'>
							Delete All Tasks
						</span>
						{showConfirm && (
